...
#ifndef INCLUDED_HALOW_HALOW_FRAME_EQUALIZER_IMPL_H
#define INCLUDED_HALOW_HALOW_FRAME_EQUALIZER_IMPL_H

#include "equalizer/base.h"
#include "viterbi_decoder/viterbi_decoder.h"
#include <gnuradio/halow/constellations.h>
#include <gnuradio/halow/halow_frame_equalizer.h>

namespace gr {
namespace halow {

class halow_frame_equalizer_impl : virtual public halow_frame_equalizer
{

public:
    halow_frame_equalizer_impl(Equalizer algo, double freq, double bw, bool log, bool debug);
    ~halow_frame_equalizer_impl();
...
#endif /* INCLUDED_HALOW_HALOW_FRAME_EQUALIZER_IMPL_H */