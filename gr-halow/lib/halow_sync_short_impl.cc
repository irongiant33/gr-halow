...
class halow_sync_short_impl : public halow_sync_short
{

public:
    halow_sync_short_impl(double threshold, unsigned int min_plateau, bool log, bool debug)
        : block("halow_sync_short",
...
halow_sync_short::sptr
halow_sync_short::make(double threshold, unsigned int min_plateau, bool log, bool debug)
{
    return gnuradio::get_initial_sptr(
        new halow_sync_short_impl(threshold, min_plateau, log, debug));
}